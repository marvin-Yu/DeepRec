...
http_archive(
    ...
    urls = [
        "http://gitlab.alibaba-inc.com/odps_tensorflow/other/raw/master/storage.googleapis.com/download.tensorflow.org/models/speech_commands_v0.01.zip",
        "http://gitlab.alibaba-inc.com/odps_tensorflow/other/raw/master/download.tensorflow.org/models/speech_commands_v0.01.zip",
    ],
)
