...
do
    ...
    bazel build --copt=-mavx2 --copt='-DINTEL_MKL_GEMM_ONLY' --config=mkl_gemm_only -c opt --config=cuda  --copt -mfpmath=both --copt -mfma --copt -msse4.2 --copt -DGOOGLE_CUDA=1 --copt -D_GLIBCXX_USE_CXX11_ABI=0 $target
done
