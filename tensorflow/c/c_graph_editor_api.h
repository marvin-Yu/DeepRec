...
TF_CAPI_EXPORT extern void TF_BypassGather(const char** bypass_op_names,
                                           int n_opnames,
                                           const char** bypass_blacklist,
                                           int n_blacklist,
                                           TF_Buffer* graph_def,
                                           TF_Status* status);
...
TF_CAPI_EXPORT extern void TF_InsertConcatOp(
    ...
    TF_Status* status);
TF_CAPI_EXPORT extern void TF_TagCPUDevice(
    const char** inputs, int n_inputs, const char** outputs,
