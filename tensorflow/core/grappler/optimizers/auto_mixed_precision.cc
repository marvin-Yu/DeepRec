...
// If ops have one or more type_attr, But some of type_attr could not be changed to F16.
// Such as FusedBatchNormV2, its type_attr 'U' only support float. We will Remove this node
// from allow_set.
