...
#include "tensorflow/compiler/tf2tensorrt8/convert/convert_graph.h"
...
#include "tensorflow/compiler/tf2tensorrt8/convert/logger_registry.h"
#include "tensorflow/compiler/tf2tensorrt8/convert/utils.h"
#include "tensorflow/compiler/tf2tensorrt8/segment/segment.h"
...
Status CreateTRTNode(const ConversionParams& params,
  ...
  if (info.engine_type == EngineInfo::EngineType::TRTStatic) {
    TF_RETURN_IF_ERROR(CreateStaticEngine(
        params, info, max_batch_size, input_shapes, nullptr, &segment_string, &(params.total_flops)));
  }
...
Status CreateStaticEngine(const ConversionParams& params,
                          ...
                          string* segment_string, int64_t* total_flops) {
  ...
  TF_RETURN_IF_ERROR(ConvertGraphDefToEngine(
      ...
      /*convert_successfully=*/nullptr, profile, info.engine_name, total_flops));
