...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        urls = [
            "https://github.com/oneapi-src/oneDNN/archive/refs/tags/v3.4.2.tar.gz",
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/oneapi-src/oneDNN/archive/refs/tags/v3.4.2.tar.gz",
        ],
    )
    ...
    tf_http_archive(
        ...
        patch_file = clean_dep("//third_party:com_google_absl_fix.patch"),
    ...
    tf_http_archive(
        ...
        urls = [
            ...
            "http://86067763.oss-cn-hangzhou-zmf.aliyuncs.com/tensorflow_cache/8071cda5714d.tar.gz",
        ],
    )
    ...
    tf_http_archive(
        ...
        patch_file = clean_dep("//third_party/grpc:upb_gcc_11_fix.patch"),
    ...
    tf_http_archive(
        name = "boringssl",
        patch_file = clean_dep("//third_party:boringssl_fix.patch"),
